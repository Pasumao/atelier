...
export const PillarsSection = component(function PillarsSection() {
  return html`
    <section class="section-shell" id="pillars">
      <p class="eyebrow">WHY ATELIER</p>
      <h2 class="h-section">这一页背后的框架特色</h2>
      <p class="sub-section">Atelier —— 为 AI 编程代理设计的新前端框架。以下八根支柱全部在本页实时运行：</p>
      <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-md">
        {#each PILLARS as p}
