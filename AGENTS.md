...
| `atelier/tests/` | runtime 单测（vitest，<!--@num:tests-->135<!--@/--> 用例：内核/契约/表达式 fuzz/codegen golden DOM 对拍/F-2 静态依赖差分对拍/桥接/HMR/token DTCG/mcp-confirm 闸；M3 评分 harness 无 env 时整体 skip）。 |
