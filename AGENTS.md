...
| `atelier/` | Agent Skills 作者副本（多工具兼容版）：`skills/` 为 kebab-case 目录包（根 atelier + 7 个子技能包，dsh/Claude Code/Codex 通用形态），`templates/` 为 AGENTS.md/llms.txt 生成模板；README.md 有兼容矩阵与安装说明。M1 已交付，M2/M3 见计划书。 |
